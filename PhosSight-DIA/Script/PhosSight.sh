...
# TODO: Predict detectability score for $syn_fasta_dir/combined_syn_yeast_ecoli_castor_original.fasta and $A549_fasta_dir/human_all_peptides_2_7_46.fasta and output in $syn_fasta_dir/peptide_scores_finetuned.txt and $A549_fasta_dir/peptide_scores_finetuned.txt using pretrained PhosDetect. Finetune PhosDetect model using the result in $syn_result_dir and $A549_result_dir (directory for_fintuning_res), and get the fine-tuned PhosDetect, generate the detectability score for $syn_fasta_dir/combined_syn_yeast_ecoli_castor_original.fasta and $A549_fasta_dir/human_all_peptides_2_7_46.fasta and output in $syn_fasta_dir/peptide_scores_finetuned.txt and $A549_fasta_dir/peptide_scores_finetuned.txt
