...
class PhosSightFinetuner:
    ...
    def finetune_on_four_testsets(self):
        """在四个测试集上微调模型"""
...
def main():
    parser = argparse.ArgumentParser(description='Finetune PhosSight model on four test sets')
    ...
    # 开始微调
    results = finetuner.finetune_on_four_testsets()
