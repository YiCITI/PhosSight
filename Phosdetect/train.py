...
def split_data(path, batch_size=32, val_size=0.05, test_size=0.05):
...
def parse_args():
    ...
    parser.add_argument('-b', '--batch_size', type=int, default=128, help='Batch size for training and testing.')
    ...
    parser.add_argument('--model_type', type=str, default='bigru_improved_v2', choices=['bigru', 'bigru_improved', 'bigru_improved_v2', 'transformer'], help='Model type: bigru, bigru_improved, bigru_improved_v2 or transformer')
    ...
    parser.add_argument('--scheduler', type=str, default='plateau', choices=['plateau', 'cosine', 'step'], help='Learning rate scheduler type')
...
if __name__ == "__main__":
    ...
    train_loader, val_loader, test_loader = split_data(path, batch_size=batch_size, val_size=args.val_size, test_size=args.test_size)
